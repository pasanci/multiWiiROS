...
private:
	...
	rclcpp::Service<mavros_msgs::srv::CommandBool>::SharedPtr ser_arm;
	rclcpp::Service<mavros_msgs::srv::CommandBool>::SharedPtr ser_force_arm;
	...
	void arm(const std::shared_ptr<mavros_msgs::srv::CommandBool::Request> request, std::shared_ptr<mavros_msgs::srv::CommandBool::Response> response);
	void force_arm(const std::shared_ptr<mavros_msgs::srv::CommandBool::Request> request, std::shared_ptr<mavros_msgs::srv::CommandBool::Response> response);
};
